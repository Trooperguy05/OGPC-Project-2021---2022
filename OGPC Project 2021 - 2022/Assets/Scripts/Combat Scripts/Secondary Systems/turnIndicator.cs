...
public class turnIndicator : MonoBehaviour
{
    ...
    public void updateIndicator() {
        ...
        if (cM.initiativeNames[cM.initiativeIndex] == "Raza") {
            ...
            if (cM.gameObjectsInCombat[cM.initiativeIndex] == gameObjects[4]) {
            ...
            else if (cM.gameObjectsInCombat[cM.initiativeIndex] == gameObjects[5]) {
                indicatorRenderer.sprite = enemyIndicator;
            ...
            else if (cM.gameObjectsInCombat[cM.initiativeIndex] == gameObjects[6]) {
                indicatorRenderer.sprite = enemyIndicator;
            ...
            else if (cM.gameObjectsInCombat[cM.initiativeIndex] == gameObjects[7]) {
                indicatorRenderer.sprite = enemyIndicator;
