...
public class HealthbarManager : MonoBehaviour
{
    ...
    public void updateEnemyHealthbars() {
        enemy1Healthbar.GetComponent<RectTransform>().position = new Vector2(cM.enemy1.transform.position.x+1.75f, cM.enemy1.transform.position.y+0.25f);
        enemy2Healthbar.GetComponent<RectTransform>().position = new Vector2(cM.enemy2.transform.position.x+1.75f, cM.enemy2.transform.position.y+0.25f);
        enemy3Healthbar.GetComponent<RectTransform>().position = new Vector2(cM.enemy3.transform.position.x+1.75f, cM.enemy3.transform.position.y+0.25f);
        enemy4Healthbar.GetComponent<RectTransform>().position = new Vector2(cM.enemy4.transform.position.x+1.75f, cM.enemy4.transform.position.y+0.25f);
    }
